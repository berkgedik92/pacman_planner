...
public class UngroundProblem
{
	...
	public Set<String> requirements = new HashSet<String>();                // Requirements of the domain     (String)

    public Set<SimpleType> types = new HashSet<SimpleType>();                       // For simple object types in this domain       (SimpleTypes)
	public Map<String, Type> typeMap = new Hashtable<String, Type>();                   // Set for mapping String -> types  (String => Type)
	public Map typeSets = new Hashtable();                 // Maps a type on to a set of PDDLObjects (Type => Set (PDDLObjects))

    public Set<PredicateSymbol> predSymbols = new HashSet<PredicateSymbol>();                 // Set of all (ungrounded) predicate     (PredicateSymbol)
	public Map<String, PredicateSymbol> predSymbolMap = new Hashtable<String, PredicateSymbol>();             // Maps Strings of the symbol to the Symbols (String => PredicateSymbol)
	...
	public Set<FunctionSymbol> funcSymbols = new HashSet<FunctionSymbol>();                 // Set of all function symbols (FunctionSymbol)
	public Map<String, FunctionSymbol> funcSymbolMap = new Hashtable<String, FunctionSymbol>();             // Maps Strings onto the Symbols (String => FunctionSymbol)

	public Set<Operator> actions = new HashSet<Operator>();                     // List of all (ungrounded) actions      (Operators)
